...
const brands: Brand[] = [
  ...
  { src: '/images/smc/13.png', label: 'Air management system' },
  { src: '/images/smc/14.png', label: 'Compact compressor' },
  { src: '/images/smc/15.png', label: 'Pressure control equipment' },
  { src: '/images/smc/16.png', label: 'Booster regulator' },
  { src: '/images/smc/17.png', label: 'Lubrication equipment' },
  { src: '/images/smc/18.png', label: 'Gas Generator' },
  { src: '/images/smc/19.png', label: 'Flow control equipment / speed controllers' },
  { src: '/images/smc/20.png', label: 'Silencers/exhaust cleaners / pressure gauges' },
  { src: '/images/smc/21.png', label: 'Air blowing equipment'},
  { src: '/images/smc/22.png', label: 'static neutralization equipment' },
  { src: '/images/smc/23.png', label: 'chemical liquid valves / fittings & Needle valves / tubings' },
  { src: '/images/smc/24.png', label: 'Temperature control equipments' },
  { src: '/images/smc/25.png', label: 'Industrial filters  / sintered metal elements'},
  { src: '/images/smc/26.png', label: 'Pneumatic Instrumentation Equipment' },
